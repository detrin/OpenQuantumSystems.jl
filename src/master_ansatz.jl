...
function QME_sI_ansatz_const_1(
    ...
    tmp1 = copy(W0.data)
    tmp2 = copy(W0.data)
    dmaster_(t, rho, drho, history_fun, p) = dQME_sI_ansatz_const_1(
        t,
        rho,
        drho,
        history_fun,
...
function dQME_sI_ansatz_const_1(
    t::AbstractFloat,
    rho::T,
    drho::T,
    history_fun,
...
function kernel_sI_ansatz_const_1(t, s, h, p, tmp1, tmp2, Ham_II_t)
...
function QME_sI_ansatz_const_2(
    ...
    tmp1 = copy(W0.data)
    tmp2 = copy(W0.data)
    dmaster_(t, rho, drho, history_fun, p) = dQME_sI_ansatz_const_2(
        t,
        rho,
        drho,
        history_fun,
...
function dQME_sI_ansatz_const_2(
    t::AbstractFloat,
    rho::T,
    drho::T,
    history_fun,
...
function kernel_sI_ansatz_const_2(t, s, h, p, tmp1, tmp2, Ham_II_t)
    aggCore, aggTools, aggOperators, W0, W0_bath, _ = p
...
function QME_sI_ansatz_upart2(
    ...
    tmp1 = copy(W0.data)
    tmp2 = copy(W0.data)
    dmaster_(t, rho, drho, history_fun, p) = dQME_sI_ansatz_upart2(
        t,
        rho,
        drho,
        history_fun,
...
function dQME_sI_ansatz_upart2(
    t::AbstractFloat,
    rho::T,
    drho::T,
    history_fun,
