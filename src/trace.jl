        ...
        for I in 1:aggIndLen
            ...
            for J in 1:aggIndLen
                ...
                for m in 1:vibLen
                    ...
                    rho_traced[elOrder1-1, elOrder2-1] += FCFact[K, I] * rho[I, J] * FCFact[J, L]
                end
            end
        end
    else
        for I in 1:aggIndLen
            ...
            for J in 1:aggIndLen
                ...
                for m in 1:vibLen
                    K = vibindices[elOrder1][m]
                    L = vibindices[elOrder2][m]
                    rho_traced[elOrder1, elOrder2] += FCFact[K, I] * rho[I, J] * FCFact[J, L]
                end
            end
        end
    end
...
function trace_bath(rho::T, agg, FCFact, aggIndices, vibindices; groundState=false) where {B<:Basis, T<:Operator{B,B}}
    rho_traced = trace_bath(rho.data, agg, FCFact, aggIndices, vibindices; groundState=groundState)
