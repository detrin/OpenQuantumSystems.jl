...
@testset "metrics" begin
    ...
    @test tracenorm(rho) ≈ 1.0
    @test tracenorm_h(rho) ≈ 1.0
    @test tracenorm_nh(rho) ≈ 1.0
    ...
    @test tracedistance_h(rho, rho) ≈ 0.0
    ...
    rho_pT1_an =
        0.5 * (dm(e ⊗ g) + dm(g ⊗ e) - (e ⊗ e) ⊗ dagger(g ⊗ g) - (g ⊗ g) ⊗ dagger(e ⊗ e))
