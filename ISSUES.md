...
| #66 | Standardize naming conventions | Convention | Minor | DONE |
...
|----------|-------|--------|--------|
| 1 | **#67** Fix tutorial to use current API | Unblocks all new users | DONE (v0.5.0) |
| 2 | **#76** Adopt Julia-idiomatic patterns | Architectural foundation for everything below | DONE (v0.5.0) |
| 3 | **#68** Add `SimulationResult` type | Eliminates overload explosion, consistent API | DONE (v0.5.0) |
| 4 | **#69** Molecule-count coupling matrix | Removes biggest physicist confusion | DONE (v0.5.0) |
| 5 | **#71** Unified `solve()` entry point | Discoverable API, reduced cognitive load | DONE (v0.5.0) |
| 6 | **#70** Document naming conventions + glossary | Helps existing users read the code | DONE (v0.5.0) |
| 7 | **#72** Physical validation | Catches silent numerical errors | DONE (v0.5.0) |
| 8 | **#74** Solver selection guide in docs | Guides new users | DONE (v0.5.0) |
| 9 | **#73** Fix unit conversion | Small cleanup | DONE (v0.5.0) |
| 10 | **#75** Convenience constructors | Lowers barrier for common cases | DONE (v0.5.0) |
